...
export const metadata: Metadata = {
  title: "LedgerMem Eval — Open Memory Benchmarks",
  description:
      ...
      <body className="min-h-screen bg-white text-neutral-900 antialiased">
        <header className="border-b border-neutral-200">
          <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
            ...
            <nav className="flex gap-6 text-sm">
              ...
              <a href="https://github.com/ledgermem/ledgermem-eval">GitHub</a>
            </nav>
          </div>
        </header>
        ...
        <footer className="border-t border-neutral-200">
          <div className="mx-auto max-w-5xl px-6 py-6 text-sm text-neutral-500">
            Apache 2.0 — built by the LedgerMem team. All numbers are
